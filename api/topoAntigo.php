		...
		<ul>
			...
			<?php if($_SESSION['administrador'] == 1) {?>
				<li>
					...
					<ul>
						<li>
	                        <a href="grid_produtos.php" title="Cadastrar Produto"><span class="menu-item-parent">Produtos</span></a>
	                    </li>
	                    <li>
	                        <a href="grid_usuarios.php" title="Cadastra Usuário"><span class="menu-item-parent">Usuários</span></a>
	                    </li>

			    <li>
	                        <a href="graficoConsumo.php" title="Consumo Mensal"><span class="menu-item-parent">A Receber</span></a>
	                    </li>

	                    <li>
	                        <a href="relatoriosProdutos.php" target="_blank" title="Relatórios Produtos"><span class="menu-item-parent">Rel. Produtos</span></a>
	                    </li>

	                    <li>
	                        <a href="relatoriosUsuario.php" target="_blank" title="Relatórios Usuários Consumo"><span class="menu-item-parent">Rel. Usuários</span></a>
	                    </li>
                            <li>
                                <a href="qrcode.php" target="_blank" title="Gerar QRCode Pagina"><span class="menu-item-parent">QRCode</span></a>
                            </li>
					</ul>
				</li>
