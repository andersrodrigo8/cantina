						...
						<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-1" data-widget-editbutton="false">
								...
								<header>
									...
									<h2> <a href="pop_usuarios.php" class="btn btn-info btn-xs">Usuários Novos </a> </h2>
										...
										<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
									        ...
									        <thead>
												<tr>
													...
													<th class="hasinput" style="width:12%">
														<input type="text" class="form-control" placeholder="Devedor" />
													</th> 
									            ...
									            <tr> 
                                                    ...
                                                    <th data-hide="phone, tablet">Nível</th>
								                    <th data-hide="phone, tablet">Email</th> 
								                    <th data-hide="phone, tablet">Saldo Devedor</th> 
								                    <th>Ação</th>
									            </tr>
									        </thead>
