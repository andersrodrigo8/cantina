				...
				<div class="row">
					<div class="col-xs-12">
						<div class="well no-padding">
							<form action="index.php" method="post" class="smart-form client-form">
								<fieldset>
									<section>
										<label class="label">E-mail</label>
										<label class="input"> <i class="icon-append fa fa-user"></i>
											<input type="email" name="email" value="">
											<b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> Entre com Login</b></label>
									</section>
								...
								<footer>
									<button type="submit" class="btn btn-primary" name="BotaoAcao" value="LoginSistema">
										Entrar
									</button>
								</footer>
							</form>
