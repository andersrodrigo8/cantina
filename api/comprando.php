    ...
    <div id="content">
        ...
        <section id="widget-grid" class="">
            ...
            <div class="row" id="tabelaMostruario">
                <?php $queryProdutos = selectFindProdutos($db, $id);  ?>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                <div class="product-image">
                                    <!--<img src="<?php echo $queryProdutos['pathfoto'];?>" width=200 height=200 class="img-responsive"> -->
                                    <img src="<?php echo $queryProdutos['pathfoto'];?>" width=194 height=228>
                                    <?php if($queryProdutos['promocao']){ ?>
                            ...
                            <div class="col-md-7 col-sm-12 col-xs-12">
                                <div class="product-deatil">
                                    <h5 class="name">
                                        <strong>
                                            <?php echo $queryProdutos['titulo']; ?>
                                        </strong>
                                    </h5>
                                    <p class="price-container">
                                        <span>R$ <?php echo number_format($queryProdutos['valor'],2,","); ?></span>
                                    </p>
                                    <span class="tag1"></span>
                                </div>
                                <div class="description">
                                    <?php echo $queryProdutos['descricao']; ?>
                                    <select class="form-control" id="Quantidade_<?php echo $queryProdutos['id']; ?>">
                                        <?php for($i=1; $i<=$queryProdutos['quantidade']; $i++) {
                                            echo '<option value="'.$i.'">'.$i.'</option>';
                                        } ?>
                                    </select>
                                    <br>
                                    <a title="Comprar" id="<?php echo $queryProdutos['id']; ?>" onClick="CarregaProduto(this.id);" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal"><i class="fa fa-money"></i> Comprar</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="efetuarCompra(<?php echo $id; ?>)" class="btn btn-success"><i class="fa fa-money"></i>
                            Comprar
                        </button>
